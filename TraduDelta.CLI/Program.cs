...
internal class Program
{
    ...
    {
        cmdutils.print("Welcome to TraduDelta.CLI by D3fau4!", ConsoleColor.Green);
            ...
            switch (args[0])
            {
                ...
                case "--extracttext":
                    if (args.Length < 3)
                    {
                        ...
                        cmdutils.print("Usage: TraduDelta.CLI.exe --extracttext game.win lang_en_ch1.json");
                        break;
                    }
    ...
    {
        cmdutils.print("TraduDelta.CLI.exe [MODE] [FILE/DIRECTORY]\n");
