...
.localvar 14481 load_chapter 6218
.localvar 11424 _id 6219
.localvar 11941 _locale 6250
.localvar 11943 _lang 6251
.localvar 14522 is_fullscreen 6252
...
push.s "The Beginning"@14508
conv.s.v
pushi.e -1
pushi.e 1
pop.v.v [array]self.chapname
push.s "A Cyber's World"@14509
conv.s.v
pushi.e -1
pushi.e 2
pop.v.v [array]self.chapname
