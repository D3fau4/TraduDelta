...
public class Gamewin2Po : IHelper
{
    public void Process(string s1, string s2, string s3)
    {
        if (s1.Contains(".win"))
        {
            ...
            using (var stream = new FileStream(s1, FileMode.Open, FileAccess.Read))
            {
                        ...
                        str[i].Contains("gml_Script_scr_84_get_lang_string_ch1"))
                    {
                        ...
                        try
                        {
                            if (str[i].Contains("gml_Script_scr_84_get_lang_string_ch1"))
                            {
                                ...
                                buffervalue.Append(json.getvaluefromjson(s2, bufferkey.ToString()));
                            }
            ...
            json.cleanjson("lang_en.json", s3);
