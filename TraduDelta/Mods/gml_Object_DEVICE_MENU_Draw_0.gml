    ...
    for (i = 0; i < 3; i += 1)
    {
        ...
        if (CONT_THIS < 4 || CONT_THIS == 11)
        {
            ...
            if (MENU_NO == 10 || MENU_NO == 11)
            {
                ...
                if filefound
                {
                    ...
                    NOWNAME = gml_Script_stringsetloc("FILE not found.", "DEVICE_MENU_slash_Draw_0_gml_130_0")
                else
                {
                    NOWNAME = gml_Script_stringsetloc("Completion FILE not found.", "DEVICE_MENU_slash_Draw_0_gml_125_0")
                    NOWTIME = " "
                }
            }
            if (global.lang == "es")
        ...
        if (CONT_THIS >= 1)
        {
            if (TYPE == 0)
            {
                if (MENU_NO == 1)
                {
                    SELTEXT_C = gml_Script_stringsetloc(" ", "DEVICE_MENU_slash_Draw_0_gml_115_0")
                    SELTEXT_A = gml_Script_stringsetloc("CONTINUE", "DEVICE_MENU_slash_Draw_0_gml_116_0")
                    SELTEXT_B = gml_Script_stringsetloc("BACK", "DEVICE_MENU_slash_Draw_0_gml_116_1")
                    if (FILE[MENUCOORD[0]] == 0)
                    {
                        SELTEXT_A = gml_Script_stringsetloc("BEGIN", "DEVICE_MENU_slash_Draw_0_gml_117_0")
                        SELTEXT_B = gml_Script_stringsetloc("BACK", "DEVICE_MENU_slash_Draw_0_gml_117_1")
                    }
                }
                if (MENU_NO == 4)
                {
                    SELTEXT_A = gml_Script_stringsetloc("OVERWRITE", "DEVICE_MENU_slash_Draw_0_gml_119_0")
                    SELTEXT_B = gml_Script_stringsetloc("DO NOT", "DEVICE_MENU_slash_Draw_0_gml_119_1")
                    SELTEXT_C = gml_Script_stringsetloc("IT WILL BE SUBSUMED.", "DEVICE_MENU_slash_Draw_0_gml_119_2")
                }
                if (MENU_NO == 6)
                {
                    SELTEXT_A = gml_Script_stringsetloc("YES", "DEVICE_MENU_slash_Draw_0_gml_120_0")
                    SELTEXT_B = gml_Script_stringsetloc("NO", "DEVICE_MENU_slash_Draw_0_gml_120_1")
                    SELTEXT_C = gml_Script_stringsetloc("TRULY ERASE IT?", "DEVICE_MENU_slash_Draw_0_gml_120_2")
                }
                if (MENU_NO == 7)
                {
                    SELTEXT_A = gml_Script_stringsetloc("ERASE", "DEVICE_MENU_slash_Draw_0_gml_121_0")
                    SELTEXT_B = gml_Script_stringsetloc("DO NOT", "DEVICE_MENU_slash_Draw_0_gml_121_1")
                    SELTEXT_C = gml_Script_stringsetloc("THEN IT WILL BE DESTROYED.", "DEVICE_MENU_slash_Draw_0_gml_121_2")
                }
            }
            else
            {
                if (MENU_NO == 1)
                {
                    SELTEXT_C = gml_Script_stringsetloc(" ", "DEVICE_MENU_slash_Draw_0_gml_127_0")
                    SELTEXT_A = gml_Script_stringsetloc("Continue", "DEVICE_MENU_slash_Draw_0_gml_128_0")
                    SELTEXT_B = gml_Script_stringsetloc("Back", "DEVICE_MENU_slash_Draw_0_gml_128_1")
                    if (FILE[MENUCOORD[0]] == 0)
                    {
                        SELTEXT_A = gml_Script_stringsetloc("Start", "DEVICE_MENU_slash_Draw_0_gml_129_0")
                        SELTEXT_B = gml_Script_stringsetloc("Back", "DEVICE_MENU_slash_Draw_0_gml_129_1")
                    }
                }
                if (MENU_NO == 4)
                {
                    SELTEXT_A = gml_Script_stringsetloc("Yes", "DEVICE_MENU_slash_Draw_0_gml_131_0")
                    SELTEXT_B = gml_Script_stringsetloc("No", "DEVICE_MENU_slash_Draw_0_gml_131_1")
                    SELTEXT_C = gml_Script_stringsetloc("Copy over this file?", "DEVICE_MENU_slash_Draw_0_gml_131_2")
                }
                if (MENU_NO == 6)
                {
                    SELTEXT_A = gml_Script_stringsetloc("Yes", "DEVICE_MENU_slash_Draw_0_gml_132_0")
                    SELTEXT_B = gml_Script_stringsetloc("No", "DEVICE_MENU_slash_Draw_0_gml_132_1")
                    SELTEXT_C = gml_Script_stringsetloc("Erase this file?", "DEVICE_MENU_slash_Draw_0_gml_132_2")
                }
                if (MENU_NO == 7)
                {
                    SELTEXT_A = gml_Script_stringsetloc("Yes!", "DEVICE_MENU_slash_Draw_0_gml_133_0")
                    SELTEXT_B = gml_Script_stringsetloc("No!", "DEVICE_MENU_slash_Draw_0_gml_133_1")
                    SELTEXT_C = gml_Script_stringsetloc("Really erase it?", "DEVICE_MENU_slash_Draw_0_gml_133_2")
                }
                if (MENU_NO == 11)
                {
                    SELTEXT_A = gml_Script_stringsetloc("Start", "DEVICE_MENU_slash_Draw_0_gml_164_0")
                    SELTEXT_B = gml_Script_stringsetloc("Back", "DEVICE_MENU_slash_Draw_0_gml_165_0")
            ...
            gml_Script_draw_text_shadow((BOX_X1 + 125), (BOX_Y1 + 22), SELTEXT_B)
        }
        else
        {
            ...
            if (MENU_NO == 10 || MENU_NO == 11)
            {
                if (COMPLETEFILE_PREV[i] == 1)
                    NOWPLACE = gml_Script_stringsetloc("Your Room [Chapter 1 END]", "DEVICE_MENU_slash_Draw_0_gml_194_0")
                else
                    NOWPLACE = gml_Script_stringsetloc("[Made on seeing credits.]", "DEVICE_MENU_slash_Draw_0_gml_195_0")
                if INCOMPLETE_LOAD
                    NOWPLACE = COMPLETEFILE_PREV_PLACE[i]
            }
            gml_Script_draw_text_shadow_width((BOX_X1 + 25), (BOX_Y1 + 22), NOWPLACE, 180)
        }
    }
}
if (MENU_NO >= 0)
{
    ...
    if (MENU_NO >= 2)
    {
        CANCELTEXT = gml_Script_stringsetloc("CANCEL", "DEVICE_MENU_slash_Draw_0_gml_189_0")
        if (TYPE == 1)
    ...
    if (MENU_NO == 0 || MENU_NO == 1)
    {
        ...
        if (global.lang == "ja")
            jamod = 10
        COPYTEXT = gml_Script_stringsetloc("COPY", "DEVICE_MENU_slash_Draw_0_gml_199_0")
        ERASETEXT = gml_Script_stringsetloc("ERASE", "DEVICE_MENU_slash_Draw_0_gml_200_0")
        ...
        if (global.lang == "en")
            LANGUAGETEXT = gml_Script_stringset("日本語")
        if (global.lang == "es")
            LANGUAGETEXT = gml_Script_stringset("English")
        if (global.lang == "ja")
            LANGUAGETEXT = gml_Script_stringset("Español")
        if (TYPE == 1)
        {
    ...
    if (MESSAGETIMER <= 0)
    {
        ...
        {
            if (MENU_NO == 0 || MENU_NO == 1)
                TEMPCOMMENT = gml_Script_stringsetloc(" ", "DEVICE_MENU_slash_Draw_0_gml_215_0")
            if (MENU_NO == 2)
                TEMPCOMMENT = gml_Script_stringsetloc("CHOOSE THE ONE TO COPY.", "DEVICE_MENU_slash_Draw_0_gml_216_0")
            if (MENU_NO == 3)
                TEMPCOMMENT = gml_Script_stringsetloc("CHOOSE THE TARGET FOR THE REFLECTION.", "DEVICE_MENU_slash_Draw_0_gml_217_0")
            if (MENU_NO == 4)
                TEMPCOMMENT = gml_Script_stringsetloc("IT WILL BE SUBSUMED.", "DEVICE_MENU_slash_Draw_0_gml_218_0")
            if (MENU_NO == 5 || MENU_NO == 6 || MENU_NO == 7)
                TEMPCOMMENT = gml_Script_stringsetloc("SELECT THE ONE TO ERASE.", "DEVICE_MENU_slash_Draw_0_gml_219_0")
        }
        if (TYPE == 1)
        {
            if (MENU_NO == 0 || MENU_NO == 1)
                TEMPCOMMENT = gml_Script_stringsetloc("Please select a file.", "DEVICE_MENU_slash_Draw_0_gml_223_0")
            if (MENU_NO == 2)
                TEMPCOMMENT = gml_Script_stringsetloc("Choose a file to copy.", "DEVICE_MENU_slash_Draw_0_gml_224_0")
            if (MENU_NO == 3)
                TEMPCOMMENT = gml_Script_stringsetloc("Choose a file to copy to.", "DEVICE_MENU_slash_Draw_0_gml_225_0")
            if (MENU_NO == 4)
                TEMPCOMMENT = gml_Script_stringsetloc("The file will be overwritten.", "DEVICE_MENU_slash_Draw_0_gml_226_0")
            if (MENU_NO == 5 || MENU_NO == 6 || MENU_NO == 7)
                TEMPCOMMENT = gml_Script_stringsetloc("Choose a file to erase.", "DEVICE_MENU_slash_Draw_0_gml_227_0")
            if (MENU_NO == 10)
                TEMPCOMMENT = gml_Script_stringsetloc("Start Chapter 2 from Chapter 1's FILE.", "DEVICE_MENU_slash_Draw_0_gml_291_0")
            if (MENU_NO == 11)
