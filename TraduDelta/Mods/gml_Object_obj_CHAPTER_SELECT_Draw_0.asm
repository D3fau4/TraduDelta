...
:[43]
push.s "¿Quieres empezar desde el capítulo 1?"@14525
conv.s.v
b [45]

:[44]
push.s "Capítulo 1から始めますか？"@14526
conv.s.v
...
call.i draw_set_color(argc=1)
popz.v
push.s "Capítulo"@14532
push.v self.highestCompletedChapter
call.i string(argc=1)
add.v.s
push.s " completado."@14533
add.s.v
pop.v.v self.my_stringset
push.s "Jugar capítulo "@14534
push.v self.highestCompletedChapter
pushi.e 1
add.i.v
call.i string(argc=1)
...
:[87]
push.s "Seleccionar otro capítulo"@14538
conv.s.v
b [89]
...
call.i draw_set_color(argc=1)
popz.v
push.s "Continue from Capítulo "@14543
push.v self.highestUncompletedChapter
call.i string(argc=1)
add.v.s
push.s "?"@4778
